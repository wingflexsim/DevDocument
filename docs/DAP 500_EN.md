...
3. Device parameter read/write operations (e.g., version information, personalized settings) use the FEATURE protocol for bidirectional transmission.
...
| 5-62       | Reserved             | uint8_t   | -         | (Reserved)                                                                    |
...
Byte 3:  [Backlight Brightness]
Byte 5-62: Reserved
```

## FEATURE Report

**REPORT_ID = 3 (FEATURE Report)**

Used for bidirectional transmission of device parameter read/write operations, such as lighting brightness, version information, etc.
