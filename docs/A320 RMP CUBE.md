...
| Data Type                   | Double Byte Type                | -    |   17   |   -   |    0    |
| Data Length                 | Following data occupies 8 Byte  | -    |   18   |   -   |  0x08   |
...
**About Left/Right Dot Position**

使用这个标志位可以控制显示某一个小数点，只能同时显示一个。

**About Left/Right Display Digit Switch**

Use this flag to control whether a digit is displayed. Binary 0010 0000 means displaying the leftmost first digit, 0001 0000 means the second digit, and so on.
0011 1111 means all 6 digits are displayed simultaneously.

使用这个标志位，可以控制某一位数字是否显示。二进制 0010 0000 表示显示最左边第一位数字，0001 0000 表示第二位数字。以此类推。
0011 1111 表示6位数字同时显示。
